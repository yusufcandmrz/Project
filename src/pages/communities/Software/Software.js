...
import styles from "./Software_style";
...
const MessageCard = ({ message }) => {
    ...
    function addNotes() {
        ...
        firebase.app().database('https://proje-fcbf6-default-rtdb.europe-west1.firebasedatabase.app/').ref('/users/' + currentUser + '/notes/communities/software/' + message.id).set({
...
const Software = () => {
    ...
    const messagesReference = firebase.app().database('https://proje-fcbf6-default-rtdb.europe-west1.firebasedatabase.app/').ref('/messages/communities/software');
